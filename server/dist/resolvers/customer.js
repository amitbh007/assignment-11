...
let CustomerResolver = class CustomerResolver {
    getCustomers() {
        return __awaiter(this, void 0, void 0, function* () {
            return Customer_1.Customer.findAll();
        });
    }
    addCustomer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customerBuild = Customer_1.Customer.build(newCustomer);
            return yield customerBuild.save();
        });
    }
    deleteAllCustomers() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Customer_1.Customer.destroy({
                where: {},
                truncate: true
            });
        });
